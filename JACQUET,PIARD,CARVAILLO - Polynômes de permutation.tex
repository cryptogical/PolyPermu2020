...
Lorsque la caractéristique est supérieure à $2$, il est possible d'avoir $\delta_f$ égal à $1$. Les fonctions vérifiant cette valeur de $\delta$ sont appelées fonctions Parfaitement Non-linéaires, ou \mathbb{PN}.\\
...
Les fonctions dites \mathbb{APN}, pour Almost Perfect Nonlinear, sont les fonctions pour lesquelles cette borne est atteinte.
...
\subsubsection{Les fonctions courbes}
