...
\end{figure}
\pagebreak
Nous allons ensuite présenter une implémentation sous forme algoritheoremique du \textbf{Critère 1} présenté précédemment. Cet algorithme est développé en \textit{Sage}.
\begin{minted}
[
frame=lines,
framesep=2mm,
...
\section{Application des caractères additifs}
