...
Ceci nous a conduit, tout du long, à exhiber différents critères d’identification et à implémenter certains d’entre eux. Ces derniers permettant de décider quels polynômes sont, ou non de permutations ; donc, à fortiori, de trouver de « bons » polynômes de permutations pour une application en cryptologie. \newline

?? notamment pour le crypto système RSA énoncé plus haut (\textbf{N.B :} Partie détaillée au semestre 2). ?? \newline
