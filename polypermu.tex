...
\end{center}
\vspace{12pt}
En effet cette application n'est pas injective. Soient $(X,Y) \in (\F_5 \times \F_5)$. On a $P(X)=P(Y)$ si et seulement si $X^2=Y^2$. En prenant $X=3$ et $Y=-2$ on fausse l'injectivité.
	\end{itemize}
\end{examples}
\end{document}
