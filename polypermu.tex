...
\begin{bg}
Possiblement implémentable ?\newline
Si oui, \textbf{Arthur : oui il est implémentable mais je verrai si ça n'est pas trop compliqué}
\end{bg}
...
\end{figure}
\pagebreak
Maintenant nous allons présenter un algorithme permettant une implémentation du \textbf{Critère 2}. Il a été lui aussi développé en \textit{Sage}.
...
answer = "non"
answer2 = "non"
if estDePermutation(test1,2):
    answer = "oui"
if estDePermutation(test2,2):
    answer2 = "oui"
